...
function themeprefix_slick_enqueue_scripts_styles() {
	...
	wp_enqueue_script( 'slickjs', get_stylesheet_directory_uri() . '/js/vendor/slick.min.js', array( 'jquery' ), '1.6.0', true );
	wp_enqueue_script( 'slickjs-init', get_stylesheet_directory_uri(). '/js/vendor/slick-init.js', array( 'slickjs' ), '1.6.0', true );

	wp_enqueue_style( 'slickcss', get_stylesheet_directory_uri() . '/css/vendor/slick.css', '1.6.0', 'all');
	wp_enqueue_style( 'slickcsstheme', get_stylesheet_directory_uri(). '/css/vendor/slick-theme.css', '1.6.0', 'all');
